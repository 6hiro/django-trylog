...
urlpatterns = [
    ...
    path('reset/', accounts_views.ResetAPIView.as_view(), name='reset-password'),
    ...
    path('followers/', accounts_views.get_followers,
    ...
    # path('post/like/profile/', posts_views.get_profiles_like_post,
